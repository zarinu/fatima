    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="card my-3 p-3 shadow-sm text-center">

                    @if($courses->count())
                        <p class="font-25 "> 👇 دوره های شما 👇 </p>
                    ...
                    @else
                        <p class="font-15 text-danger"> هنوز دوره‌ای برای شما فعال نشده است. </p>
                        <p class="font-15">اگر قبلا دوره ای را خریداری کرده اید که فعال نیست لطفا به <a href="https://eitaa.com/aroosak_admin">پشتیبان سایت (کلیک کنید)</a> پیام دهید. </p>
                    @endif
