<div class="col-lg-3 "><!-- start right sidebar -->
    ...
    <div class="card border-0 shadow-sm bg-info mb-2"><!-- start avatar box -->
...
{{--        <a href="{{route('dashboard')}}" class="list-group-item list-group-item-action font-13 text-info"> <i class="fa fa-home align-middle me-2 font-13 text-secondary"></i>پیشخوان</a>--}}
        ...
        <a href="{{route('courses.panel')}}" class="list-group-item list-group-item-action font-13 text-info"><i class="fas fa-graduation-cap align-middle me-2 text-secondary"></i>دوره های شما</a>
